...
<head>
    ...
    <title>Штани для дівчат купити в Україні!</title>
    <link rel="shortcut icon" href="../../images/favicon/favicon.png" type="image/x-icon">

    <!-- CSS -->
    <link rel="stylesheet" href="../../css/style.css">
    <link rel="stylesheet" href="./css/shtany.css">
                    ...
                    <ul class="header-menu">
                        ...
                        <li class="header-menu__item"><a href="#" class="header-menu__link" id="header__activ">Одяг</a>
                            <ul>
                                ...
                                <li><a href="" class="header-row-menu__link">ШТАНИ</a></li>
                            </ul>
                        </li>
    ...
    <block>
        <div class="container">
            <div class="title_card">
                <a href="#" class="title_card_link">ШТАНИ</a>
            </div>
            ...
            <div class="trace">
                <ul>
                    ...
                    <div class="block-line"></div>
                    <li>
                        <trace__activ>Штани</trace__activ>
                    </li>
                </ul>
            </div>
        ...
        <div class="product ">
            <div class="container">
                <div class="product-cards">
                    <?php
                    $select_product = mysqli_query($conn, "SELECT * FROM `shtany`") or die('query failed');
