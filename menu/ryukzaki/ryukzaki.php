...
<head>
    ...
    <title>Рюкзаки жіночий купити в Україні.</title>
    <link rel="shortcut icon" href="../../images/favicon/favicon.png" type="image/x-icon">

    <!-- CSS -->
    <link rel="stylesheet" href="../../css/style.css">
    <link rel="stylesheet" href="./css/ryukzaki.css">
    ...
    <block>
        <div class="container">
            <div class="title_card">
                <a href="#" class="title_card_link">РЮКЗАКИ</a>
            </div>
            ...
            <div class="trace">
                <ul>
                    ...
                    <div class="block-line"></div>
                    <li>
                        <trace__activ>Рюкзаки</trace__activ>
                    </li>
                </ul>
            </div>
        ...
        <div class="product ">
            <div class="container">
                <div class="product-cards">
                    <?php
                    $select_product = mysqli_query($conn, "SELECT * FROM `ryukzaki`") or die('query failed');
