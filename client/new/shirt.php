            ...
            <div class="header-row">
                ...
                <div class="header-column">
                    ...
                    <ul class="header-menu">
                        <li class="header-menu__item"><a href="./shirt.php" class="header-menu__link">
                                <red>Знижки</red>
                            </a> </li>
    ...
    <block>
        <div class="container">
            <div class="title_card">
                <a href="#" class="title_card_link">ЗНИЖКИ</a>
            </div>
        </div>
    </block>
        ...
        <div class="product ">
            <div class="container">
                <div class="product-cards">
                    <?php
                    $select_product = mysqli_query($conn, "SELECT * FROM `shirt`") or die('query failed');
